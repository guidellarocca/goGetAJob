...
user = User.new(
  ...
  Job.create!([{
    ...
    job_author: "Facebook",
    user_id: user.id,
    avatar: Rails.root.join("app/assets/images/facebook.jpeg").open,
    remote_ok: false
  },
  {
    ...
    job_author: "Slack",
    user_id: user.id,
    avatar: Rails.root.join("app/assets/images/slack.jpeg").open,
    remote_ok: false
  },
  {
    ...
    job_author: "Trello",
    user_id: user.id,
    avatar: Rails.root.join("app/assets/images/trello.jpeg").open,
    remote_ok: true
  },
  {
    ...
    user_id: user.id,
    avatar: Rails.root.join("app/assets/images/wordpress.jpeg").open,
    remote_ok: true
  },
  {
    ...
    job_author: "Basecamp",
    user_id: user.id,
    avatar: Rails.root.join("app/assets/images/basecamp.jpeg").open,
    remote_ok: true
  },
  {
    ...
    job_author: "Twitter",
    user_id: user.id,
    avatar: Rails.root.join("app/assets/images/twitter.jpeg").open,
    remote_ok: true
  },
  {
    title: "Writer",
    ...
    user_id: user.id,
    avatar: Rails.root.join("app/assets/images/web-crunch.jpeg").open,
    remote_ok: true
  }
  ])